                    ...
                    <div className="col-md-8 col-md-offset-2">
                        <div className="fh5co-hero-wrap">
                            <div className="fh5co-hero-intro">
                                ...
                                <h2 className="to-animate hero-animate-2">Quiero saber si soy celiaco</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container-fluid">
                          <div className="row animate-box" id="polldiv">
                            <div className="col-md-12 heading text-center">
                                          <button className="btn btn-outline btn-lg" id="comenzar_2">Comenzar Cuestionario</button>
                            </div>
                          </div>
                    </div>
                </div>
