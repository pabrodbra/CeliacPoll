			      ...
			      <div className="col-md-12">
			         <div className="fh5co-hero-wrap">
			            <div className="fh5co-hero-intro">
			               <h1 className="to-animate hero-animate-1">Regístrate</h1>
			               <h2 className="to-animate hero-animate-2">Para poder hacer uso de nuestros servicios</h2>
			            </div>
			         </div>
			      </div>
			   </div>
			      ...
			      <div className="container">
			         <div className="row">
			               ...
			               <form action="#" method="post">
			                  ...
			                  <div className="col-md-12">
			                     <div className="form-group">
			                        ...
			                        <input placeholder="Password" id="pass" type="password" className="form-control input-lg"/>
			                     </div>
			                  </div>
			                  <div className="col-md-12">
			                     <div className="form-group">
			                        <label for="pass" className="sr-only">Contraseña</label>
			                        <input placeholder="Confirm Password" id="pass2" type="password" className="form-control input-lg"/>
			                     </div>
			                  </div>
			                  <div className="col-md-12">
			                     <div className="form-group">
			                        <input type="submit" className="btn btn-primary btn-lg " value="Registrarse"/>
			                     </div>
			                  </div>
			               </form>
			            </div>
			            <div className="col-md-4">
			               ...
			               <p>No se preocupe le podemos generar otra para que no pierda sus resultados</p>
			               <p>
			                  <a href="SignUp.html">Olvidé mi contraseña</a>
			               </p>
			            </div>
			         </div>
			      </div>
